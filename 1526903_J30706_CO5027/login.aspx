...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="content">
	<br/>
                        ...
                        <asp:TextBox ID="TxtPassword" runat="server" Height="22px" style="margin-top: 50px" Width="211px" TextMode="Password"></asp:TextBox>
                        
                        <br />
			               
                        

                        <asp:Button ID="btnlogin" runat="server" Text="login" Height="39px" style="margin-top: 50px" Width="142px" OnClick="btnlogin_Click" CssClass="auto-style2" />
