...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<table id="table1">
			...
			<tr>
				...
				<td class="about-style4">Cotton ONz</td>
			</tr>
			<tr>
				<th class="about-style5" style="width: 146px">Colour:</th> 
				<td class="about-style4">Green, Blue (Floral)</td>
			</tr>
			<tr>
				<th class="about-style5" style="width: 146px">Care Label:</th> 
				<td class="about-style4"><br>Machine wash warm inside out</br>
											<br>Wash dark colors separately</br>
											<br>Dry promptly</br>
											<br>Non-chlorine bleach if necessary</br>
											<br>Tumble dry low</br>
											<br>Cool iron</br>
											<br>Do not iron on prints</br>
											<br>Dry clean</br></td>
			</tr>
			<tr>
				<th class="about-style5" style="width: 146px">Material:</th> 
				<td class="about-style4">90% Silk, 5% Elastane</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="about-style4">China </td>
			</tr>
			<tr>
