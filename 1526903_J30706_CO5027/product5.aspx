<%@ Page Title="product5" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="product5.aspx.cs" Inherits="_1526903_J30706_CO5027.product5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<table id="table1">
				<tr>
					<td>
					<img src="images/clothes5.jpg" alt="clothes5" width="450" height="450" onclick="openModal();currentSlide(1)" class="hover-shadow cursor"></td>	
				</tr>
			...
			<tr>
				...
				<td class="about-style4">Red, Grey, Blue (Tribal)</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="about-style4">Spain </td>
			</tr>
			<tr>
