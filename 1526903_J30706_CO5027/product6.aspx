<%@ Page Title="product6" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="product6.aspx.cs" Inherits="_1526903_J30706_CO5027.product6" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<table id="table1">
				<tr>
					<td>
					<img src="images/clothes6.jpg" alt="clothes6" width="450" height="450" onclick="openModal();currentSlide(1)" class="hover-shadow cursor"></td>	
				</tr>
			...
			<tr>
				...
				<td class="about-style4">Green, Brown (Floral)</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="about-style4">95% Silk, 5% Elastane</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="about-style4">Indonesia </td>
			</tr>
			<tr>
